================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PrivacyFilter プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PrivacyFilter には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PrivacyFilter アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

PrivacyFilter.vcproj
...
PrivacyFilter.h
   ...
   CPrivacyFilterApp アプリケーション クラスを宣言します。

PrivacyFilter.cpp
   これは、アプリケーション クラス CPrivacyFilterApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PrivacyFilter.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル PrivacyFilter.rc に含まれていま
   す。

res\PrivacyFilter.rc2
...
PrivacyFilterDlg.h, PrivacyFilterDlg.cpp - ダイアログ
   これらのファイルは CPrivacyFilterDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な PrivacyFilter.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   PrivacyFilter.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
